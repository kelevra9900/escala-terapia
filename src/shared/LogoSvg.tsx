...
const LogoSvg: React.FC<React.SVGAttributes<{}>> = (props) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" {...props} viewBox="0 0 270 210">
			<g id="_240px" data-name="240px" transform="translate(1364 -894)">
				<rect id="Rectangle_4" data-name="Rectangle 4" {...props} rx="5" transform="translate(-1364 894)" fill="#fff" />
