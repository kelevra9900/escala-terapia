	...
	return (
		<Popover className="relative flex flex-1">
			{({ open, close }) => (
				<>
					<PopoverButton
						className={`z-10 flex w-full flex-shrink-0 items-center text-start ${fieldClassName} cursor-pointer gap-x-3 focus:outline-none ${
						...
						<div className="flex-1">
							<span className="block overflow-hidden font-semibold xl:text-lg">
								<span className="line-clamp-1">
									{typeOfPropertyText || T['HeroSearchForm']['Type']}
								</span>
							</span>
							<span className="mt-1 block text-sm font-light leading-none text-neutral-400">
								{T['HeroSearchForm']['Property type']}
							</span>
						</div>
					</PopoverButton>
